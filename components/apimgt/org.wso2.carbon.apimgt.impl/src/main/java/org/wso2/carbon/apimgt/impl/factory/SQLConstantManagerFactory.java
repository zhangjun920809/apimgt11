...
public class SQLConstantManagerFactory {
    ...
    private static SQLConstantDm sqlConstantDm = null;
    ...
    public static void initializeSQLConstantManager() throws APIManagementException {
        ...
        try {
            ...
            } else if (connection.getMetaData().getDriverName().contains("Dm")) {
                dbType = "dm";
                sqlConstantDm = new SQLConstantDm();
            } else{
